...
public class ComputeResultAndGrade {
	public static void main(String[] args) {
		...
		if(percentage >= 80) {
			System.out.printf("Excellent! You got the A Grade with %d percent marks. \nRemarks: Level 4, above agency-normalized standards", percentage);
		}
		else if(percentage >= 70) {
			System.out.printf("Hurrah! You got the B Grade with %d percent marks. \nRemarks: Level 3, at agency-normalized standards", percentage);
		}
		else if(percentage >= 60) {
			System.out.printf("Good! You got the C Grade with %d percent marks. \nRemarks: Level 2, below, but approaching agency-normalized standards", percentage);
		}
		else if(percentage >= 50) {
			System.out.printf("You got the D Grade with %d percent marks. \nRemarks: Level 1, well below agency-normalized standards", percentage);
		}
		else if(percentage >= 40) {
			System.out.printf("You got the E Grade with %d percent marks. \nRemarks: Level 1-, too below agency-normalized standards", percentage);
		}
		else {
			System.out.printf("Sorry! You got the R Grade with %d percent marks. \nRemarks: Remedial Standards", percentage);
		}
		input.close();
	}
}
